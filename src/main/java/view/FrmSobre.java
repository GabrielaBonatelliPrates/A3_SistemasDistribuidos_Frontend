...
public class FrmSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JTASobre.setRows(5);
        JTASobre.setText("    Este é um projeto realizados por alunos da UNISUL, de um sistema distribuido de armazenamento de uma loja, com banco de dados e interface gráfica. \n\n\n                                                                                      Dentre os colaboradores temos:\n\n\n\t        Nomes:\t\t                    Usuários do GitHub (Caso tenha interesse em nosso trabalho):\n\n\tCesar Augusto dos Santos\t\t\tc3sarrr\n\tDavi Wolff de Abreu\t\t\tDavi-Wolff\n\tGabriela Bonatelli Prates\t\t\tGabrielaBonatelliPrates\n\tMateo Alessandro Padilla Chalela\t\tMateo-Padilla\n\n\n              Utilizamos o MySQL 8 como o banco de dados e o protocolo de RMI (Remote Method Invocation) como arquitetura da distribuição.\n");
